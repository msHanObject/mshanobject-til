...
import javastory.msClub2.stage2.ui.console.ClubConsole;
...
public class ClubMenu {
	...
	public ClubMenu() {
		//
		this.clubMemershipMenu = new ClubMemershipMenu();
	...
	private void displayMenu() {
		...
		narrator.sayln("...........................");
		narartor.sayln(" 5. Membership menu");
		narrator.sayln("...........................");
	...
	private int selectMenu() {
		...
		int meunNumber = scanner.nextInt();
