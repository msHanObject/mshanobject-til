public class ClubServiceLogic implements ClubService {
	...
	public ClubServiceLogic() {
		...
		this.autoIdMap = MapStorage.getInstace().getAutoIdMap();
	}

	@Override
	public void registerClub(TravelClub clubDto) {
		//
		...
		if (club instanceof AutoIdEnitty) {
	...
	public void addMembership(ClubMembershipDto membershipDto) {
		...
		foundMember.getMembersihpList().add(clubMembership);
