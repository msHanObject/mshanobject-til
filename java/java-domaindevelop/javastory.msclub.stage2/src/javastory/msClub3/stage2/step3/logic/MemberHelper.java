package javastory.msClub3.stage2.step3.logic;
...
public class MemberHelper {
	...
	public void modify(ClubMember member, Map<String,Stirng> newValueMap) {
		//
		Iterator<String> nameIter = newValueMap.keSet().iterator();
