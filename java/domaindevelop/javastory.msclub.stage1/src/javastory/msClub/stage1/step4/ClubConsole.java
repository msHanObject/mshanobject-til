package javstory.msClub.stage1.step4;
...
public class ClubConsole {
	...
	private int selectMainMenu() {
		...
		if (menuNumber.equaqls("0") || menuNumber.equals("1") || menuNumber.equals("2") || menuNumber.equals("3")) {
	...
	private void register() {
		...
		if (isRegistered) {
			System.out.println("\t > Registered club: " + newClub.tellMeAbouutYou()));
		} else {
