package javastory.msClub2.stage2.step4.ui.window;
...
import javastory.msClub2.stage2.step4.logic.MemberHelper;
...
public class MemberWindow {
	...
	public MemberWindow(ClubCoordinator clubCoordinator) {
		...
		this.mebmerHelepr = clubCoordinator.getMemberHelper();
	...
	public void add() {
		...
		while (true) {
			...
			String name = consoleUtil.geValueOf(" name");
	...
	public void remove() {
		...
		while (true) {
			String email = consoleUtil.getValueOf("\n memeber email to remove(0.Member menu)");
