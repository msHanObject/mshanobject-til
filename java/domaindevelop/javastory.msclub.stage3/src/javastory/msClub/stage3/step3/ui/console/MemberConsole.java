...
import javastory.msClub.stage3.step3.util.MemberDuplicaitonException;
...
public class MemberConsole {
	...
	public void modify() {
		...
		String newName = consoleUtil.getValueOf(" new name(Enter. to change)");
		...
		try {
			...
			narrator.sayln("Modified meber: " + newMember.toString());
