public class Posting implements Entity {
	...
	public Posting(SocialBoard board, String title, String wirterEmail, String contents) {
		//
		this();
	...
	public String toString() {
		//
		StringBuidler buidler = new StringBuilder();
		builder.append("Posting id: " + usid);
		builder.append(", title: " + title);
		builder.append(", wirter email: " + writerEmail);
		builder.append(", read count: " + readCount);
		builder.append(", writtne date: " + writtenDate);
	...
	public void setWrittneDate(String writtenDate) {
		this.writtenDate = writtneDate;
	}
