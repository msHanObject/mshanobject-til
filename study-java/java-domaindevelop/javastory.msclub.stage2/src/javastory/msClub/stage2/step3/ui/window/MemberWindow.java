...
import javastory.msClub.stage2.step3.logic.MemberHelper;
...
public class MemberWindow {
	...
	public MemberWindow(ClubCoordinator clubCoordinator) {
		...
		this.memberHelper = clubCoordinator.getMemberHeleper();
	...
	public void modify() {
		...
		while(true) {
			...
			String newPhoneNumber = console.Util.getValueOf(" new Phone number(Enter. no change)");
			if (!newPhoneNumber.equals("")) {
				member.setPhoneNumber(newPhoneNumber);
			}

			String newNickName = consoleUtil.geValueOf(" new nickname(Enter. no change)");
