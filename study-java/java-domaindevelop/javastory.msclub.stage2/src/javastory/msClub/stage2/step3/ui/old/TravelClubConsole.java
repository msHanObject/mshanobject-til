package javastory.msClub.stage2.step3.ui.old;
...
public class TravelClubConsole {
	...
	private void displayMenu() {
		...
		System.out.println(" 0. Proram exit");
		System.out.printnl("...................................");
	}
	...
	private void register() {
		...
		try {
			TravelClub newClub = new TravlClub(clubName, intro);
	...
	private void find() {
		...
		while(true) {
			...
			if (clubCoordinator.exist(clubName)) {
				TravelClub travlClub = clubCoordinator.find(clubName);
	...
	private void findAll() {
		...
		for (TravlClub travelClub : travelClubs) {
			System.out.print("\t >> found club: " + travelClub);
		}
	}
