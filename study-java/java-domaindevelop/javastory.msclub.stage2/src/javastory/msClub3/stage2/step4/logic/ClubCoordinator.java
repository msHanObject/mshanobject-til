package javastory.msClub3.stage2.step4.logic;

import java.util.Collection;

import javastory.msClub3.stage2.step1.entity.TravelClub;
import javastory.msClub3.stage2.step4.storage.TravelClubStore;
import javastory.msClub3.stage2.util.ClubDuplicationException;
import javastory.msClub3.stage2.util.InvalidArgumentException;
...
public class ClubCoordinator {
	...
	public Collection<TravelClub> findAll(int offset, int pageSize) throws InvalidArgumentException {
		if (!(pageSize == MIN_PAGE_SIZE || pageSize == MAX_PAGES_SIZE)) {
