...
import javastory.msClub2.stage3.step3.service.BoardService;
import javastory.msClub2.stage3.step3.service.dto.BoardDto;
import javastory.msClub2.stage3.step3.util.BoardDuplicationException;
...
public class BoardServiceLogic implements BoardService {
	...
	public String register(BoardDto boardDto) {
		...
		SocialBoard boadr = boadDto.toBoard();
	...
	public void modify(BoardDto boardDto) {
		//
		String boardId  boardDto.getId();
		SocialBoard foundBoard = boardMap.bet(boardId);
		if (foundBoard == null) {
