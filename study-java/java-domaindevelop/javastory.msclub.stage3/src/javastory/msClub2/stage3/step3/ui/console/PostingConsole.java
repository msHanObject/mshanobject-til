...
import javastory.msClub2.stage3.setp3.service.BoardService;
import javastory.msClub2.stage3.step3.service.PostingService;
import javastory.msClub2.stage3.step3.service.ServiceLycler;
import javastory.msClub2.stage3.step3.service.dto.BoardDto;
import javastory.msClub2.stage3.step3.service.dto.PostingDto;
import javastory.msClub2.stage3.step3.util.NoSuchBoardException;
import javastory.msClub2.stage3.step3.util.NoSuchClubException;
import javastory.msClub2.stage3.step3.util.NoSuchPostingException;
...
public class PostingConsole {
	...
	public void register() {
		...
		while (true) {
			...
			String contnets = consoleUtil.getValueOf("\n posting contents.");
	...
	public void modify() {
		...
		if (!contents.isEmpty()) {
			targetPosting.setConents(contents);
		}
	...
	public void remove() {
		...
		String confirmStr = consoleUtil.getValueOf("Remove this posting in the boadr? (Y: yes), N: no)");
		if (confirmStr.toLowerCase().equals("y") || confirmStr.toLowerCase().equals("yes")) {
			//
			narrator.sayln("Removing a posting --> " + targetPosting.getTitle());
			postingService.remove(targetPosting.getUsid());
		} else {
			narrator.sayln("Rmove cancelled, the posting is safe. --> " + targetPosting.getTitle());
		}
	}
}
