...
import javastory.msClub2.stgae3.step3.logic.storage.MapStorage;
import javastory.msClub2.stage3.step3.service.PostingService;
import javastory.msClub2.stage3.step3.service.dto.PostingDto;
import javastory.msClub2.stage3.step3.util.NoSuchBaordException;
...
public class PostingServiceLogic implements PostingService {
	...
	public void register(String boardId, PostingDto postingDto) {
		//
		SocialBoard foudnBoard = boardMap.get(boardId);
		if (foundBoard == null) {
