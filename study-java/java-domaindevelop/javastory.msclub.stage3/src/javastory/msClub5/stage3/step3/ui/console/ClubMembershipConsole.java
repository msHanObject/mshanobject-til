public class ClubMembershipConsole {
	...
	public ClubMembershipConsole() {
		//
		ServiceLycler serviceFactory = ServiceLogicLycler.shareInstatnce();
	...
	public void add() {
		...
		while(true) {
			...
			try {
				...
				narrator.sayln("The Role in club should be president of member.");
			}
		}
	}
	...
	public void modify() {
		...
		ClubMembershipDto modifiedMembership = clubService.findMembershipIn(clubId, targetMembersihp.getMemberEmail());
	...
	public void remove() {
		...
		if (confirmsStr.toLowerCase().equals("y") || confirmStr.toLowerCase().equals("yes")) {
			//
