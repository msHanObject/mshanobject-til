...
import javastory.msClub.stage3.step1.club.CommunityMember;
...
public class Posting implements Entity {
	...
	public String toString() {
		...
		builder.append("Positng id: " + usid);
	...
	public void setContnets(String contents) {
		this.contents = contents;
	}
