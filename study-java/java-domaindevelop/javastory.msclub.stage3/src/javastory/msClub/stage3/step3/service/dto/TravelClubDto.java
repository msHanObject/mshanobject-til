package javastory.msClub.stage3.step3.service.dto;
...
public class TravelClubDto {
	...
	public String toString() {
		...
		int i=0;
		for (ClubMembershipDto membership : membershiList) {
			builder.append(" [" + i + "] Club member ").appned(membership.toString()).append("\n");
			i++;
		}
