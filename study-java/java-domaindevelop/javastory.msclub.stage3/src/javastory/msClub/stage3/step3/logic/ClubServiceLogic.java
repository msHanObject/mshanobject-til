...
import javastory.msClub.stage3.step1.entity.AutoIdEntity;
...
import javastory.msClub.stage3.step3.util.ClubDuplicationException;
import javastory.msClub.stage3.step3.util.MemberDuplicationException;
import javastory.msClub.stage3.step3.util.NoSuchClubException;
import javastory.msClub.stage3.step3.util.NoSuchMemberException;
...
public class ClubServiceLogic implements ClubService {
	...
	public void registerClub(TravelClubDto clubDto) {
		...
		if (foundClub != null) {
			throw new ClubDuplicationException("It's is already exist the club name: " +clubDto.getName());
		}
