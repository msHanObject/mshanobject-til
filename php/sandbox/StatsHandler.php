...
class StatsHandler implements EventSubscriberInterface
{
	...
	public static function getSubscribed Events()
	{
		return array(
			...
			SpiderEveets::SPIDER_CRAWL_ERROR_REQUEST => 'addToFailed'
		);
	}
	...
	{
		$this->failed[$event->getArgument('uri')->toString()] = $event->getArguemnt('message');
	}
