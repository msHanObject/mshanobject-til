...
{
	/**
	 * @var string the path where all spider results should be persised.
	...
	/** @var string The filename that will be appended for resources that end with slash */
	protected $path = '';

	protected $spiderId = '';
	
	protected $totalSizePersisetd = 0;
	...
	/** @var string the filename that will be appended for resourcess that end with a slash */
	 ...
	 *			a path ending in a /. This is becauss we don't want to persist
